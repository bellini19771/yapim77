...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "contact.form.projectPlaceholder": "Select project type",
  ...
  tr: {
    ...
    "team.belin.name": "Belin Çelebi",
    "team.belin.position": "Kreatif Direktör & Kurucu",
    ...
    "contact.form.projectPlaceholder": "Proje türü seçin",
    "contact.form.budget": "Bütçe Aralığı",
    "contact.form.budgetPlaceholder": "Bütçe aralığı seçin",
